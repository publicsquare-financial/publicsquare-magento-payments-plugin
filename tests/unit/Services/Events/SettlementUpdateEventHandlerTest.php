...
class SettlementUpdateEventHandlerTest extends TestCase
{
    ...
    private SettlementUpdateEventHandler $handler;
    ...
    function setup(): void
    {
        ...
        $this->handler = new SettlementUpdateEventHandler(
            $this->logger,
    ...
    function testHappyPath(): void
    {
        ...
        $payment->expects($this->once())
            ...
            ->with($this->callback(function ($info) {
                return isset($info['psq_settlement_id']) && $info['psq_settlement_id'] === 'stl_1';
            }));
    ...
    function testMissingSettlementId(): void
    {
        $event = [
            'id' => 'test event',
            'event_type' => 'settlement:update',
