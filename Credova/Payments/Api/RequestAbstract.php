...
use Credova\Payments\Exception\ApiException;
...
abstract class RequestAbstract
{
    ...
    /**
     * @var \Credova\Payments\Helper\Config
     */
    ...
    public function getResponseData(): array
    {
        ...
        if (is_null($data) && json_last_error() !== JSON_ERROR_NONE) {
            throw new ApiException(__('Error decoding Credova response body: %1', json_last_error()));
        }
