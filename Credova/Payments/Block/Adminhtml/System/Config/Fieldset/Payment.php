...
namespace Credova\Payments\Block\Adminhtml\System\Config\Fieldset;

/**
 * Fieldset renderer credova solution
 */
class Payment extends \Magento\Config\Block\System\Config\Form\Fieldset
{
    ...
    protected function _getHeaderTitleHtml($element)
    {
        ...
        <button type="button"' . $disabledAttributeString . ' class="button action-configure'
            . $disabledClassString . '" id="' . $htmlId . '-head" onclick="credovaToggleSolution.
    ...
    protected function _getExtraJs($element)
    {
        $script = "require(['jquery', 'prototype'], function(jQuery){
            window.credovaToggleSolution = function (id, url) {
                var doScroll = false;
