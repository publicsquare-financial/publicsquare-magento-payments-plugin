...
use Credova\Payments\Api\Authenticated\RefundsFactory;
...
class RefundCommand implements CommandInterface
{
    ...
    public function getTransactionId(\Magento\Payment\Model\InfoInterface $payment)
    {
        ...
        if (empty($matches))
        {
            throw new LocalizedException(__("The payment can only be refunded via the Credova Dashboard. You can retry in offline mode instead."));
        }
