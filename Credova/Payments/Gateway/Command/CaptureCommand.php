...
use Credova\Payments\Api\Authenticated\PaymentCaptureFactory;
...
{
    /**
     * @var \Credova\Payments\Api\Authenticated\PaymentCaptureFactory
     */
    ...
    public function execute(array $commandSubject)
    {
        ...
        try
        {
            ...
            {
                throw new LocalizedException(__('Sorry, capture failed.'));
            }
        }
        catch (\Exception $e)
        {
